...
### 2026-09-19 — Commit 5a377f89

**Environment:** Dart 3.13.4, ubuntu-latest (CI)

| Benchmark | ops/sec | µs/op |
|---|---:|---:|
| schedule_parse | 2702702 | 0.37 |
| schedule_matches | 89766 | 11.14 |
...
| config_toMap | 653594 | 1.53 |
| config_roundtrip | 281690 | 3.55 |
| state_fromMap | 487804 | 2.05 |
| state_toMap | 505050 | 1.98 |
...
| battery_budget_60_samples | 1725625 | 0.58 |
| smart_motion_speed_change | 23479110 | 0.04 |
| battery_budget_single_sample | 23252542 | 0.04 |
| smart_motion_accel_change | 22030491 | 0.05 |
| battery_budget_heavy_drain | 884518 | 1.13 |


### 2026-09-18 — Commit cd9a6534

**Environment:** Dart 3.13.3, ubuntu-latest (CI)
...
| location_toMap | 598802 | 1.67 |
| location_fromMap_toMap_roundtrip | 425531 | 2.35 |
| location_copyWithCoords | 11111111 | 0.09 |
| geofence_fromMap_circular | 4166666 | 0.24 |
...
| persist_decider_location | 20000000 | 0.05 |
| persist_decider_geofence | 20000000 | 0.05 |
| config_fromMap | 520833 | 1.92 |
| config_toMap | 621118 | 1.61 |
| config_roundtrip | 279329 | 3.58 |
| state_fromMap | 483091 | 2.07 |
| state_toMap | 512820 | 1.95 |
...
| battery_budget_single_sample | 23247898 | 0.04 |
| battery_budget_60_samples | 1725434 | 0.58 |
| battery_budget_heavy_drain | 884206 | 1.13 |
| smart_motion_accel_change | 22239313 | 0.04 |
| smart_motion_speed_change | 23564112 | 0.04 |


### 2026-08-21 — Commit 4b5015bc

**Environment:** Dart 3.13.1, ubuntu-latest (CI)
...
| persist_decider_location | 20000000 | 0.05 |
| persist_decider_geofence | 20000000 | 0.05 |
| config_fromMap | 561797 | 1.78 |
| config_toMap | 666666 | 1.50 |
| config_roundtrip | 297619 | 3.36 |
| state_fromMap | 490196 | 2.04 |
| state_toMap | 540540 | 1.85 |
| route_context_toMap | 2941176 | 0.34 |
| route_context_fromMap | 2127659 | 0.47 |
| route_context_roundtrip | 1298701 | 0.77 |
| sync_body_context_toMap_50 | 6250000 | 0.16 |
| sync_body_context_fromMap_50 | 21123 | 47.34 |
| http_config_ssl_toMap | 5555555 | 0.18 |
| http_config_ssl_fromMap | 2777777 | 0.36 |
| http_config_ssl_roundtrip | 2000000 | 0.50 |
| battery_budget_heavy_drain | 902820 | 1.11 |
| battery_budget_60_samples | 1769178 | 0.57 |
| smart_motion_accel_change | 21691627 | 0.05 |
| battery_budget_single_sample | 21501131 | 0.05 |
| smart_motion_speed_change | 21978685 | 0.05 |


### 2026-08-21 — Commit 73af17ea
...
| config_toMap | 653594 | 1.53 |
| config_roundtrip | 278551 | 3.59 |
| state_fromMap | 487804 | 2.05 |
| state_toMap | 520833 | 1.92 |
...
| http_config_ssl_fromMap | 2777777 | 0.36 |
| http_config_ssl_roundtrip | 2040816 | 0.49 |
| battery_budget_single_sample | 23251085 | 0.04 |
| battery_budget_60_samples | 1724882 | 0.58 |
| battery_budget_heavy_drain | 886740 | 1.13 |
| smart_motion_accel_change | 22056699 | 0.05 |
| smart_motion_speed_change | 23329355 | 0.04 |


### 2026-08-20 — Commit 8076b4d6
...
| carbon_trip_100_locations | 86880 | 11.51 |
| carbon_onLocation | 3846153 | 0.26 |
| carbon_setActivity | 9090909 | 0.11 |
| carbon_cumulative_report | 2439024 | 0.41 |
| persist_decider_location | 20000000 | 0.05 |
...
| route_context_roundtrip | 1298701 | 0.77 |
| sync_body_context_toMap_50 | 6250000 | 0.16 |
| sync_body_context_fromMap_50 | 21528 | 46.45 |
| http_config_ssl_toMap | 5555555 | 0.18 |
| http_config_ssl_fromMap | 2631578 | 0.38 |
| http_config_ssl_roundtrip | 1960784 | 0.51 |
| smart_motion_accel_change | 22192423 | 0.05 |
| battery_budget_60_samples | 1766895 | 0.57 |
| smart_motion_speed_change | 22023346 | 0.05 |
| battery_budget_single_sample | 21525224 | 0.05 |
| battery_budget_heavy_drain | 896539 | 1.12 |


### 2026-08-16 — Commit 19a5b202
...
| schedule_isWithin_5_entries | 73529 | 13.60 |
...
| http_config_ssl_fromMap | 2777777 | 0.36 |
| http_config_ssl_roundtrip | 2040816 | 0.49 |
| battery_budget_heavy_drain | 882328 | 1.13 |
| battery_budget_single_sample | 21686578 | 0.05 |
| battery_budget_60_samples | 1765734 | 0.57 |
| smart_motion_speed_change | 21913524 | 0.05 |
| smart_motion_accel_change | 22143873 | 0.05 |


### 2026-08-16 — Commit 1439c769
...
| persist_decider_location | 20000000 | 0.05 |
| persist_decider_geofence | 20000000 | 0.05 |
| config_fromMap | 523560 | 1.91 |
| config_toMap | 641025 | 1.56 |
| config_roundtrip | 271739 | 3.68 |
| state_fromMap | 469483 | 2.13 |
| state_toMap | 512820 | 1.95 |
| route_context_toMap | 3030303 | 0.33 |
...
| http_config_ssl_fromMap | 2777777 | 0.36 |
| http_config_ssl_roundtrip | 2040816 | 0.49 |
| smart_motion_accel_change | 23334627 | 0.04 |
| smart_motion_speed_change | 23456351 | 0.04 |
| battery_budget_heavy_drain | 886439 | 1.13 |
| battery_budget_single_sample | 23258259 | 0.04 |
| battery_budget_60_samples | 1722653 | 0.58 |


### 2026-08-16 — Commit 4bbcf6a5
...
| config_toMap | 653594 | 1.53 |
| config_roundtrip | 271739 | 3.68 |
| state_fromMap | 485436 | 2.06 |
| state_toMap | 515463 | 1.94 |
| route_context_toMap | 2941176 | 0.34 |
| route_context_fromMap | 2173913 | 0.46 |
...
| http_config_ssl_fromMap | 2857142 | 0.35 |
| http_config_ssl_roundtrip | 2000000 | 0.50 |
| battery_budget_heavy_drain | 666475 | 1.50 |
| battery_budget_single_sample | 23715109 | 0.04 |
| smart_motion_speed_change | 23390032 | 0.04 |
| smart_motion_accel_change | 23523308 | 0.04 |
| battery_budget_60_samples | 1292219 | 0.77 |


### 2026-08-15 — Commit ad4096cf
...
| schedule_isWithin_5_entries | 79617 | 12.56 |
| location_fromMap | 1470588 | 0.68 |
...
| state_toMap | 507614 | 1.97 |
| route_context_toMap | 2857142 | 0.35 |
| route_context_fromMap | 2083333 | 0.48 |
| route_context_roundtrip | 1315789 | 0.76 |
| sync_body_context_toMap_50 | 6666666 | 0.15 |
| sync_body_context_fromMap_50 | 21872 | 45.72 |
| http_config_ssl_toMap | 5555555 | 0.18 |
| http_config_ssl_fromMap | 2857142 | 0.35 |
| http_config_ssl_roundtrip | 2040816 | 0.49 |
| smart_motion_accel_change | 23531275 | 0.04 |
| battery_budget_single_sample | 23581766 | 0.04 |
| battery_budget_heavy_drain | 666067 | 1.50 |
| smart_motion_speed_change | 23178492 | 0.04 |
| battery_budget_60_samples | 1292197 | 0.77 |


### 2026-08-15 — Commit a7bbc63e
...
| schedule_isWithin_5_entries | 79936 | 12.51 |
...
| geofence_fromMap_circular | 4166666 | 0.24 |
| geofence_fromMap_polygon | 1369863 | 0.73 |
| carbon_trip_100_locations | 94696 | 10.56 |
...
| http_config_ssl_fromMap | 2631578 | 0.38 |
| http_config_ssl_roundtrip | 2040816 | 0.49 |
| smart_motion_speed_change | 23360748 | 0.04 |
| battery_budget_heavy_drain | 663036 | 1.51 |
| battery_budget_single_sample | 23445851 | 0.04 |
| smart_motion_accel_change | 23501680 | 0.04 |
| battery_budget_60_samples | 1263919 | 0.79 |


### 2026-08-15 — Commit 2303b2e5
...
| location_fromMap_toMap_roundtrip | 431034 | 2.32 |
| location_copyWithCoords | 11111111 | 0.09 |
| geofence_fromMap_circular | 4000000 | 0.25 |
| geofence_fromMap_polygon | 1265822 | 0.79 |
...
| config_toMap | 617283 | 1.62 |
| config_roundtrip | 272479 | 3.67 |
| state_fromMap | 495049 | 2.02 |
| state_toMap | 490196 | 2.04 |
| route_context_toMap | 2857142 | 0.35 |
| route_context_fromMap | 2127659 | 0.47 |
| route_context_roundtrip | 1333333 | 0.75 |
| sync_body_context_toMap_50 | 6250000 | 0.16 |
| sync_body_context_fromMap_50 | 21326 | 46.89 |
| http_config_ssl_toMap | 5555555 | 0.18 |
| http_config_ssl_fromMap | 2702702 | 0.37 |
| http_config_ssl_roundtrip | 2000000 | 0.50 |
| smart_motion_speed_change | 22977521 | 0.04 |
| battery_budget_60_samples | 1286475 | 0.78 |
| battery_budget_single_sample | 23588073 | 0.04 |
| battery_budget_heavy_drain | 666003 | 1.50 |
| smart_motion_accel_change | 23480611 | 0.04 |
