...
- **On foot:** the `50` m default is loose for pedestrians — at walking pace a 40 m-accuracy fix can contribute more "distance" than the user actually covered. Tighten to ~`10` for walking, or let [auto-tuning](/en/core/driving-safety#auto-tuning-the-location-filters) pick it per detected activity.
