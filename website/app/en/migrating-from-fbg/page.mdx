...
locationTemplate              → ⚠️ accepted but NOT wired — see "Not supported" below
geofenceTemplate              → ⚠️ accepted but NOT wired — see "Not supported" below
...
- **`audit.includeExtrasInHash`** — ⚠️ deprecated, not implemented: the chain always hashes
  the core location fields only
