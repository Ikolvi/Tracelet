...
# podspec vendors TraceletCore.xcframework that nothing ever puts on disk, and
...
# sibling copy in tracelet_sync is loaded into the same Ruby process, and a
# shared module plus `__dir__` would let whichever file was required last answer
# for both podspecs.
module TraceletIosPodspec
  module_function
