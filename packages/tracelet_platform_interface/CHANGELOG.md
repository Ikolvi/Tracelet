...
- **FEAT**: Added Pigeon `TlSpeedMotionEvent` message, `TlMotionDetectionMode` and `TlStationaryTrackingMode` enums, and `TraceletEventApi.onMotionModeChange` FlutterApi method for speed-based motion detection.
