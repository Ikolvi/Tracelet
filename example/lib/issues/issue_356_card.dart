  ...
  Future<void> _run() async {
    ...
    try {
      ...
      _set(
        ...
        '3. Walk ~${exitDistance.toStringAsFixed(0)}m away and wait a few '
        'seconds. A notification "⬅️ EXIT — $_fenceId" should arrive with the '
        'app still dead.\n'
        '4. Walk back to where you started. "➡️ ENTER — $_fenceId" should '
        'arrive.\n'
